            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">
                            Commented on <?= date("d M Y", strtotime($comment['created_at'])); ?> at <?= date("H:i", strtotime($comment['created_at'])); ?>
                            by <span class="text-primary"><?= htmlspecialchars($comment['username']); ?></span>
                        </small>
